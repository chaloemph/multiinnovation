    ...
    if(isset($_POST["do"]) && $_POST["do"] != "" ){
        ...
        switch($do){
            ...
            case 'updatedata_p_ack':
                ...
                . "VALUES(NULL, :ROST_CPOS, :EXPERT_MIL_ID, :RATE_P_REMARK, :RATE_P_NUMBER, :RATE_P_RANK, :LAO_ID, :D_ID_2, :RATE_SEQ, :SALARY_ID, :ACK_ID, :RATE_P_VERSION )";
                $stmt=$db->prepare($sql);
                ...
                $sql2 = "INSERT INTO `j3_rost_transaction` (`TRANSACTION_ID`, `ROST_UNIT`, `ROST_CPOS`, `ROST_POSNAME`, `ROST_POSNAME_ACM`, `ROST_RANK`, `ROST_RANKNAME`, `ROST_LAO_MAJ`, `ROST_NCPOS12`, `ROST_ID`, `ROST_PARENT`, `ROST_NUNIT`, `ROST_NPARENT`, `ACK_NUM_ID`, `STATUS`, `VERSION`) VALUES (NULL, '".$ROST_UNIT."', '".$ROST_CPOS."', '".$ROST_POSNAME."', '".$ROST_POSNAME_ACM."', '".$_POST["RATE_P_RANK"]."', '".$_POST["RATE_P_RANK"]."', '".$_POST["RATE_SEQ"]."', '".$ROST_NCPOS12."', NULL, '".$ROST_PARENT."', '".$ROST_NUNIT."', '".$ROST_NPARENT."', '".$ACK_NUM_ID."', '1', '".$VERSION."')";
