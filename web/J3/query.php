    ...
    if(isset($_POST["do"]) && $_POST["do"] != "" ){
        ...
        switch($do){
            ...
            case 'updatedata_p_ack':
                ...
                $sql2 = "INSERT INTO j3_rost_transaction(TRANSACTION_ID, ROST_UNIT, ROST_CPOS, ROST_POSNAME, ROST_POSNAME_ACM, ROST_RANK, ROST_RANKNAME, ROST_LAO_MAJ, ROST_NCPOS12, ROST_ID, ROST_PARENT, ROST_NUNIT, ROST_NPARENT, ACK_NUM_ID, VERSION) "
                . "VALUES(:TRANSACTION_ID, :ROST_UNIT, :ROST_CPOS, :ROST_POSNAME, :ROST_POSNAME_ACM, :ROST_RANK, :ROST_RANKNAME, :ROST_LAO_MAJ, :ROST_NCPOS12, NULL, :ROST_PARENT, :ROST_NUNIT, :ROST_NPARENT, :ACK_NUM_ID , :VERSION)";
                $stmt2=$db->prepare($sql2);
                $stmt2->bindparam(':TRANSACTION_ID',NULL);
